...
<html lang = "en">
	<!-- BEGIN head -->
	<head>
		<title>Game Project | Group</title>
					...
					<div class="main-content full-width">
						...
						<div class="panel-block">
							<div class="panel-title">
								<div><h2 style="margin:10px;"><span style="margin-left:20px;">Creating a group</span></h2></div>
								<div class="right">
										...
										<div class="column8">
											<form id="groupeForm" action="Controllers/groupe_controller.php" method="post" enctype="multipart/form-data">
												...
												<p class="contact-form-email">
													Group name
													<input type="text" placeholder="name" name="cg_name" required/>
												</p>
												<input class="styled-button" type="submit" value="Create" name="cg_submit">
											</form>
										</div>
                                        <div class="column2">
											<p></p>
